...
A **shadcn/ui clone** for Laravel Blade - Beautiful, accessible components built with Tailwind CSS v4.
...
- 🎨 **57 Components** - Complete shadcn/ui component library
...
Slate includes **57 components** matching shadcn/ui:
...
- **Visual Regression Tests** - Screenshot comparison against shadcn/ui
