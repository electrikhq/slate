{{-- dropdown-menu-content.blade.php --}}
@props([
...
<div
    ...
    @click.stop
    role="menu"
    class="absolute z-50 min-w-[8rem] overflow-hidden rounded-md border border-border bg-popover text-popover-foreground shadow-md {{ $positionClass }}"
>
    <div class="p-1">
        {{ $slot }}
    </div>
