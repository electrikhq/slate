...
<{{ $as }}
    ...
    @pointerdown="startDrag({{ $handleIndex }}, $event)"
    {{ $attributes->merge(['class' => 'relative z-10 flex w-px shrink-0 touch-none items-center justify-center bg-border after:absolute after:inset-y-0 after:start-1/2 after:w-3 after:-translate-x-1/2 focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring data-[orientation=vertical]:h-px data-[orientation=vertical]:w-full data-[orientation=vertical]:after:inset-x-0 data-[orientation=vertical]:after:start-0 data-[orientation=vertical]:after:top-1/2 data-[orientation=vertical]:after:h-3 data-[orientation=vertical]:after:w-full data-[orientation=vertical]:after:-translate-y-1/2 data-[orientation=vertical]:after:translate-x-0 cursor-col-resize data-[orientation=vertical]:cursor-row-resize']) }}
>
